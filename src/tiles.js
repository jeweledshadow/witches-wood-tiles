...
{ amount: 1, name: `Watering Hole`, subtext: `If pawprint is in top 3 curiosities, it is the path chosen.`},
{ amount: 1, name: `Wolf Den`, subtext: `If pawprint is in the final 3 curiosities, +2 Damage`},
{ amount: 1, name: `Training Ground`, subtext: `If sword is in top 3 curiosities, +1 HP and -1 Step`},
{ amount: 1, name: `Bandit Camp`, subtext: `If sword is in final 3 curiosities, +2 Damage`},
{ amount: 1, name: `Vanishing Bridge`, subtext: `If magic is in top 3 curiosities, +1 Step.`},
{ amount: 1, name: `Sprites`, subtext: `If magic is in final 3 curiosities, +2 Damage.`},
{ amount: 1, name: `Magic Tower`, subtext: `If money is in top 3, -1 step and +1 Spell Card for each witch.`},
{ amount: 1, name: `Toll Bridge`, subtext: `If money is in final 3 curiosities, the adventurer exits in the direction they entered.`},
{ amount: 1, name: `Siren`, subtext: `If music is in the last 3 curiosities, take 2 free steps towards Music.`},
{ amount: 1, name: `Enchanting Lullaby`, subtext: `If music is in top 3 curiosities, +1 Step. Otherwise, +1 Damage.`}
];
